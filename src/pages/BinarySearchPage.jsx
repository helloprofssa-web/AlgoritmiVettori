...
import { cppLinesBinarySearch, binarySearchSteps } from "../algorithms/binarySearch";
...
export default function BinarySearchPage({ onBack }) {
  ...
  const steps = useMemo(() => binarySearchSteps(baseArray, target), [baseArray, target]);
  ...
  const comparisonsCount = steps
    .slice(0, stepIndex + 1)
    .filter((s) => s.activeLine === 5 || s.activeLine === 7).length;

  const rangeChangesCount = steps
    .slice(0, stepIndex + 1)
    .filter((s) => s.activeLine === 8 || s.activeLine === 10).length;
  ...
  return (
    <div className="h-screen flex">
      <div className="w-[360px] border-r border-slate-200">
        <CodeSidebar lines={cppLinesBinarySearch} activeLine={currentStep.activeLine} />
      </div>

      <div className="flex-1 overflow-y-auto bg-slate-50 p-6">
        <div className="max-w-6xl mx-auto space-y-6">
          <div className="flex items-center justify-between gap-4">
            <h1 className="text-3xl font-bold">Ricerca binaria</h1>
          ...
          <div className="grid gap-6 xl:grid-cols-3">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <br />
                <Badge>Riduzioni intervallo: {rangeChangesCount}</Badge>
              </CardContent>
            </Card>
          </div>
