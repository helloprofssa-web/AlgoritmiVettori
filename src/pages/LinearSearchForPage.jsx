...
import {
  cppLinesLinearSearchFor,
  linearSearchForSteps,
} from "../algorithms/linearSearchFor";

export default function LinearSearchForPage({ onBack }) {
  ...
  const steps = useMemo(() => linearSearchForSteps(baseArray, target), [baseArray, target]);
  ...
  const comparisonsCount = steps.slice(0, stepIndex + 1).filter((s) => s.activeLine === 2).length;
  ...
  return (
    <div className="h-screen flex">
      <div className="w-[360px] border-r border-slate-200">
        <CodeSidebar lines={cppLinesLinearSearchFor} activeLine={currentStep.activeLine} />
      </div>
        ...
        <div className="max-w-6xl mx-auto space-y-6">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-3xl font-bold">Ricerca su vettore non ordinato con for</h1>
            </div>
                ...
                <div className="flex gap-2 flex-wrap">
                  {currentStep.array.map((v, i) => {
                    ...
                    return (
                      <div
                        key={i}
                        className={`w-14 h-14 flex items-center justify-center border rounded font-bold ${isFound
                ...
                <div className="grid gap-3 md:grid-cols-2">
                  ...
                  <div className="p-3 border rounded bg-emerald-50">
                    ...
                    <div className="mt-1 text-xl font-bold text-emerald-900">
                      {currentStep.foundIndex !== null ? "trovato" : "in ricerca"}
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-1 text-sm">
                    {visibleDescriptions.map((description, index) => {
                      ...
                      return (
                        ...
                        >
                          <span
                            className={`w-8 text-xs font-mono ${isCurrent ? "text-amber-700 font-bold" : "text-slate-400"
                              }`}
                          >
                            {index + 1}.
                          </span>
