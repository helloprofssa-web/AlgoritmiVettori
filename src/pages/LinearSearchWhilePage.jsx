...
} from "../algorithms/linearSearchWhile";

export default function LinearSearchWhilePage({ onBack }) {
  ...
  const steps = useMemo(() => linearSearchWhileSteps(baseArray, target), [baseArray, target]);
  ...
  const comparisonsCount = steps.slice(0, stepIndex + 1).filter((s) => s.activeLine === 4).length;
  ...
  return (
    <div className="h-screen flex">
      <div className="w-[360px] border-r border-slate-200">
        <CodeSidebar lines={cppLinesLinearSearchWhile} activeLine={currentStep.activeLine} />
      </div>
                ...
                <div className="grid gap-3 md:grid-cols-3">
                  ...
                  <div className="p-3 border rounded bg-emerald-50">
                    ...
                    <div className="mt-1 text-xl font-bold text-emerald-900">
                      {currentStep.trovato ? "true" : "false"}
                    </div>
                  </div>
                </div>
